		...
		return this.each(function() {
			...
			object = function(length){
				...
				this.arrow = function(l,r,w,h,x,y){
					return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;width:"+w+"px;height:"+h+"px;left:"+(l-w-x)+"px;top:"+y+"px;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;width:"+w+"px;height:"+h+"px;left:"+(r+x)+"px;top:"+y+"px;\"></em>";
				};
				...
				for(a=0;a<this.length;a++){
					...
					for(c=0;c<options.count;c++){
						if(a===this.indexArr[c]){
							...
							var offset = 0;
							if(tmp > 0){
								//console.log(othis.next());
								offset = othis.next().width();
							}
							//left = offset + width + options.imgleft;
							//console.log(othis,tmp,offset,width,left);
							left -= (tmp-1) * 30;
							//console.log(a,CenIdxArr);
							if(a<CenIdxArr){
								t2-=1;
								left = left * -1;
							};
